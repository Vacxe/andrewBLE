...
public class andrewBLE extends CordovaPlugin {
    ...
    public andrewBLE(){
        ...
        final BluetoothManager bluetoothManager =
                (BluetoothManager) cordova.getSystemService(Context.BLUETOOTH_SERVICE);
  ...
  /*public void initialize(CordovaInterface cordova, CordovaWebView webView) {
    ...
    public boolean execute(final String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
      if(action.equals("startScan")){
        ...
        Log.e("Operacion no soportada: "+action);
        return false;
      }
...
public class andrewBLE extends CordovaPlugin {
  ...
  private boolean connect(final String address) {
      ...
      if (connectCallback != null) {
        try{
          JSONObject data = new JSONObject();
          data.put("name", (device.getName()? device.getName().replace(" ","") : "Sin nombre"));
          data.put("address", device.getAddress());
